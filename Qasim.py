...
os.system('xdg-open https://www.facebook.com/profile.php?id=100000798118233')

android_models=[]
try:
	xx = requests.get('https://chat.whatsapp.com/GjQUpvAucZN8c81KNlgqmm').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://chat.whatsapp.com/GjQUpvAucZN8c81KNlgqmm').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
logo=("""\033[1;91m 
 .d88b.   .d8b.  .d8888. d888888b .88b  d88. 
.8P  Y8. d8' `8b 88'  YP   `88'   88'YbdP`88 
88    88 88ooo88 `8bo.      88    88  88  88 
88    88 88~~~88   `Y8b.    88    88  88  88 
`8P  d8' 88   88 db   8D   .88.   88  88  88 
 `Y88'Y8 YP   YP `8888Y' Y888888P YP  YP  YP                                                           
\033[1;37m--------------------------------------------------
[~] Author   : 🅀🄰🅂🄸🄼  🄰🄵🅁🄸🄳🄸
[~] Facebook : 🅀🄰🅂🄸🄼  🄰🄵🅁🄸🄳🄸
[~] Tool     : 𝔽ℝ𝔼𝔼
...
def cek_apk(session,coki):
	w=session.get("https://chat.whatsapp.com/GjQUpvAucZN8c81KNlgqmm/?tab=active",cookies={"cookie":coki}).text
...
def trt6(ids,passlist):
    ...
    # 'cookie': 'datr=4BXqZIZmDEsNR_qKnapX57Yw; sb=4BXqZN0KDb_EiJMMs6BrfJzc; locale=en_GB; m_pixel_ratio=1.75; wd=412x758; fr=09VK9SdcsP7k0FotU..Bk8Xkq.hn.AAA.0.0.Bk8c5N.AWUtagGeEIk',
    'dpr': '1.75',
